...
<nav class="navbar app-navbar">
    <div class="container-fluid">
        <a class="navbar-brand app-brand" href="index.php?action=dashboard">
            <img src="public/img/logo.png" alt="MT Par" height="30">
        </a>
        <div class="d-flex align-items-center gap-2">
            <a href="index.php?action=parametros" class="btn btn-sm app-nav-btn">
